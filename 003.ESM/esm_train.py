...
class Net(nn.Module):
    def __init__(self,  num_classes):
        ...
        self.fc1 = nn.Linear(26*2 + n_global_feat, int((26*2 + n_global_feat)/2))
        ...
        self.fc2 = nn.Linear(int((26*2 + n_global_feat) / 2), int((26*2 + n_global_feat) / 6))
        torch.nn.init.xavier_uniform_(self.fc2.weight)

        self.fc3 = nn.Linear(int((26*2 + n_global_feat) / 6), num_classes)
